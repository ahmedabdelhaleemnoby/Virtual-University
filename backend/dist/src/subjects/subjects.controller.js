...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new subject (Admin/Instructor only)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get a subject by ID or slug' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.UserRole.ADMIN, client_1.UserRole.INSTRUCTOR),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update a subject (Admin/Instructor only)' }),
